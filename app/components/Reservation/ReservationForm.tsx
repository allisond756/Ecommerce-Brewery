...
const ReservationForm = () => {
  return (
    <div className="bg-lime-700 p-6 rounded-lg  border border-white">
      ...
      <div className="mt-[2rem]">
        ...
        <input 
          type="time" 
          className="px-10 py-2.5 bg-transparent block w-[80%] mx-auto mt-[1rem] rounded-lg outline-none font-bold 
            text-[17px] text-white border-[2.2px] border-gray-100" 
        />
